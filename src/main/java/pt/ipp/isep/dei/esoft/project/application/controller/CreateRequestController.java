...
public class CreateRequestController {
    ...
    public Land getLand() {
        ...
        return new Land(new PropertyType("Land"), area, location, distance , new Owner( name, ccNumber,  taxNumber,  emailAddress,  phoneNumber));
    }
    ...
    public Apartment getApartment(){
        ...
        Location location = new Location( street , city , district , state , zipCode);
        return new Apartment(new PropertyType("Apartment"), area , location , distance, new Owner (name, ccNumber,  taxNumber,  emailAddress,  phoneNumber), n_bedrooms, n_bathrooms, n_parkingSpaces, centralHeating , airConditioning );
    }
    ...
    public House getHouse(){
        ...
        return new House("House",area, location, distance, new Owner(name, ccNumber,  taxNumber,  emailAddress,  phoneNumber), n_bedrooms, n_bathrooms, n_parkingSpaces, centralHeating, airConditioning );
    }
