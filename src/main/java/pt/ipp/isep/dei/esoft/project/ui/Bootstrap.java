...
public class Bootstrap implements Runnable {
    ...
    private void addAnnouncements() {
        ...
        Announcement announcement1 = new Announcement(new Request( new Land ( new PropertyType("Land"), 134, new Location("rua António Costa", "Póvoa", "Porto", 43236) , 2.7, new Owner("owner@this.app")), new TypeBusiness("Sell"), 150000 ,new Owner("owner@this.app")), new Commission("Percentage", 5), announcementDate);
